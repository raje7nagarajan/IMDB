...
def plot_genre_counts():
    ...
    ax.bar(df['Genre'], df['Movie Count'], color='blue')
...
def plot_voting_trends():
    ...
    fig, ax = plt.subplots(figsize=(10, 6))  
    ax.bar(df['Genre'], df['Average Votes'], color='darkorange')
...
def correlation_analysis():
    ...
    plt.figure(figsize=(10, 6))
    plt.scatter(df['voting_count'], df['rating'], alpha=0.6, color='deeppink')
